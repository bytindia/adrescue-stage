...
Auth();
$pgHeadline = 'CPL/ROAS - Comparison';
$pgID = 3;
$err =''; 
...
$statement = " adAccounts WHERE uid='".$_SESSION['uid']."' AND account_status=1";
                                ...
                                <table id="datatable" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <?php if($ac_status[$sqlROW["account_status"]]=='ACTIVE') {?><a href="loading.php?pg=cpl-comparison.php?act=<?php echo $sqlROW["account_id"]; ?>&name=<?php echo $sqlROW["name"]; ?>" target="_blank" class="blue">View</a> <?php } else { echo '-'; } ?></td>                                                                           	
                                        </tr>  
                                        <?php $i++;
										} ?>                                      
                                    </tbody>
