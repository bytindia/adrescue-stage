...
<style>
  ...
  <body>
    ...
    <main class="container">
        <center><small><i>Last 30 days | <a href="cron-adset-report.php?refresh=1">Fetch live Report</a></i></small></center><br>
        <h4 style="text-align: center;" class="mt-5">Account wise report</h4>
    <table id="table1" class="table table-striped table-bordered">
                        ...
                        <?php 
                                $acc_data = [];
                                $sqlRev=mysqli_query($conn, "SELECT * FROM adset_report  WHERE delete_status=0");										
                                while($sqlROW=mysqli_fetch_array($sqlRev))
                                {
                                ...
                                <tr>  
                                    ...
                                    <td><?php echo $fmt->format(round($sqlROW['leads'])); ?></td>
                                    <td><?php echo $fmt->format(round($sqlROW['cpl'])); ?></td>
                                </tr> 
                                <?php } ?>
                        </tbody>
                    </table>
                    ...
                    <table id="table2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                        <?php 
                                $sqlRev=mysqli_query($conn, "SELECT * FROM adset_report_data");										
                                while($sqlROW=mysqli_fetch_array($sqlRev))
                                {
                                    //$client_name[str_replace('act_', '', $sqlROW['acc_id'])] = $sqlROW['client_name'];
                                ...
                                <tr class="<?php echo $bg; ?>">  
                                    ...
                                    <td><?php echo $objectives[$sqlROW['obj']]['name']; ?></td>
                                    <td><?php echo $fmt->format(round($sqlROW['spend'])); ?></td>
                                    <td><?php echo $fmt->format($sqlROW['leads']); ?></td>
                                    <td><?php echo $fmt->format(round($sqlROW['cpl'])); ?></td>
                                    <td><?php echo $fmt->format(round($acc_data[$sqlROW['acc_id']]['spend'])); ?></td>
                                    <td><?php echo $fmt->format($acc_data[$sqlROW['acc_id']]['leads']); ?></td>
                                    <td><?php echo $fmt->format(round($acc_data[$sqlROW['acc_id']]['cpl'])); ?></td>
                                </tr> 
                                <?php } ?>
                        </tbody>
                    </table>
