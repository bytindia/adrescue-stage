...
if ( $_POST['url'] == 'https://projhighrise.royallanddeveloper.com/') {

    $spreadsheetId = '18ih98q3EMgJuO8DMg_jQVMKYnjeGIeHRlMwmDAQkm54';
    $sheetTab = 'Rld-LP-Leads';
    ...
    $leadV = [[$name, $email, $ph ,$form , $source,$medium,$campaign, $srd,$term, $formatted_date]];
