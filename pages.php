                ...
                <div class="x_panel">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li> &nbsp;
                       <div class="btn-group  btn-group-sm">
                        	<a href="loading.php?pg=pages-sync.php"  class="btn btn-primary btn-sm">Sync Pages</a>                
                      	</div>  
                      </li>                      
                    </ul>
                     <?php } ?>
                  ...
                  <div class="x_content">
						...
						<?php
										...
										$sqlRev2=mysqli_query($conn, "SELECT * FROM ".$statement." AND active=1 AND admin_delete!=1 LIMIT {$startpoint} , {$per_page}");
										$tblIds = array();
										...
										$sqlRev=mysqli_query($conn, "SELECT * FROM ".$statement."  AND admin_delete!=1  LIMIT {$startpoint} , {$per_page}");
										$i = (($page-1) * $per_page ) + 1;
