                  ...
                  <div class="x_content">
                  		<?php 
									...
									if(isset($_GET['id'])) {
										...
										$sqlD=mysqli_query($conn, "SELECT c.client_name, c.email, c.daily_budget, c.fb_id, c.fb_stDt, c.fb_enDt, c.fb_received, c.g_id, c.g_stDt, c.in_id, c.in_stDt, c.ta_id, c.ta_stDt, cp.amount, c.g_enDt, c.in_enDt, c.ta_enDt, cp.date, cp.note, cp.p_amount, cp.p_date, cp.p_note FROM cashflow2 as c, cashflow_payments2 as cp WHERE c.tbl_id='".$_GET['id']."' AND c.tbl_id=cp.cashflow_id");
                                    ...
                                    <div class="container-fluid">
                                      <div class="row">		
                                                ...
                                                <div class="col-md-12">     
                                                                ...
                                                                <div data-role="dynamic-fields">
                                                                    <div class="form-inline">
                                                                    	<div class="form-group">
                                                                            ...
                                                                            <input type="text" name="amount[]"  class="form-control" id="field-value" placeholder="Amount" size="40" value="<?php if(isset($amount[$key])) { echo $amount[$key]; } ?>">
                                                                        </div>
                                                                        <span class="fa fa-paper-plane"> - </span>
                                                                        <div class="form-group"><i class="fa fa-calendar"></i>
                                                                        <input class="form-control date" class="date" id="date" name="date[]" placeholder="MM/DD/YYYY" type="text" value="<?php if(isset($date[$key])) { echo $date[$key]; } ?>"> 
                                                                        </div>
                                                                        <span class="fa fa-paper-plane"> - </span>
                                                                        <div class="form-group"><i class="fa fa-comment"></i>
                                                                        <input class="form-control note" class="note" id="note" name="note[]" placeholder="Notes" type="text" value="<?php if(isset($note[$key])) { echo $note[$key]; } ?>"> 
                                                                        </div>
                                                    ...
                                                    <br />
                                                    <a href="loading.php?pg=cashflow2.php"  class="btn btn-default">   Back</a>  
