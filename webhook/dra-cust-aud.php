...
// --- META ---
$metaAudienceMap = [
    'avalon'  => '120233934705730145',
    'astra'   => '120233934712740145',
    'polaris' => '120233934717900145',
    'secura'  => '120233934720860145',
    'clover'  => '120233934722660145'
];

$source_lower = strtolower($source);
$project_id = null;

foreach ($metaAudienceMap as $key => $id) {
...
if($project_id) {
    //echo "Project matched: " . $project_id;
    $audienceId = $project_id;
} else {
    $audienceId = '120233934754470145'; // default audience
}
