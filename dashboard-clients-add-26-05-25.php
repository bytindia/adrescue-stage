                  ...
                  <div class="x_content">
                  		<?php 
									...
									if(isset($_GET['id'])) {
										...
										$sqlD=mysqli_query($conn, "SELECT c.client_name, c.username, c.password, c.fb_id, c.g_id,  c.in_id, c.ta_id, c.name_contain, c.proj_name, c.bud_id FROM dashboard_accounts as c WHERE c.tbl_id=".$_GET['id']."");
                                    ...
                                    <div class="container-fluid">
                                      <div class="row">		
                                                ...
                                                <div class="col-md-8">     
                                                    ...
                                                    <input type="text" name="username" class="form-control" <?php if(isset($editData['username'])) { ?> value="<?php echo $editData['username']; ?>" <?php } ?>>                                                    	
                                                    <br />  
                                                    <label>Password: </label>
                                                    <input type="password" name="password" class="form-control" <?php if(isset($editData['password'])) { ?> value="<?php echo $editData['password']; ?>" <?php } ?>>                                                    	
                                                    <br />      
													<div class="clearfix"></div> 
