                  ...
                  <div class="x_content">
                  		<?php 
									...
									if(isset($_GET['id'])) {
										...
										$sqlD=mysqli_query($conn, "SELECT c.client_name, c.email, c.daily_budget, c.fb_id, c.fb_stDt, c.fb_enDt, c.fb_received, c.g_id, c.g_stDt, c.in_id, c.in_stDt, c.ta_id, c.ta_stDt, cp.amount, c.g_enDt, c.in_enDt, c.ta_enDt, cp.date, cp.note, cp.p_amount, cp.p_date, cp.p_note FROM cashflow2024 as c, cashflow_payments2024 as cp WHERE c.tbl_id='".$_GET['id']."' AND c.tbl_id=cp.cashflow_id");
                                      ...
                                      <div class="row">		
                                                ...
                                                <div class="col-md-12">     
                                                    ...
                                                    <span  class="cls_em">
														...
														//{
                                                           //$aFB_id = $aFB_amount = $aFB_received
                                                    ...
                                                    <br />
                                                    <a href="loading.php?pg=cashflow-2024.php"  class="btn btn-default">   Back</a>  
