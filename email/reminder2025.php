...
try {
	...
	if(!empty($_POST['soa_file'])  && isset($_POST['soa_file'])  && $_POST['soa_file']!='' && file_exists($path_rep.''.$_POST['soa_file'])) {
		$mail->addAttachment($path_rep.''.$_POST['soa_file']);  		   // Add attachments
	}
	if(!empty($_POST['soa_pi_file']) && isset($_POST['soa_pi_file']) && $_POST['soa_pi_file']!='' && file_exists($path_rep.''.$_POST['soa_pi_file'])) {
		$mail->addAttachment($path_rep.''.$_POST['soa_pi_file']);  		   // Add attachments
	}
