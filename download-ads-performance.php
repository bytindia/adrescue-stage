...
class ParallelReportDownload
{
    ...
    public static function runExample(
        ...
        $selector->setFields(
            ['AccountDescriptiveName', 'AverageCpc', 'AccountCurrencyCode', 'Impressions', 'Clicks', 'Cost', 'AverageCost', 'AverageCpm', 'CostPerConversion', 'Ctr']
        );
...
foreach ($s_dt as $key => $value) {
	$fromDt = date('Ymd', $s_dt[$key]);
	$enDt = date('Ymd', $e_dt[$key]);
	ParallelReportDownload::main($accIds, $fromDt, $enDt, $key, $g_mcc, $g_refresh_token, $server_path);
	//exit;
}
