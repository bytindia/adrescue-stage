...
if(isset($_POST['dt_submit'])){
	...
	$_SESSION['stDt'] = $start ;
	$_SESSION['enDt'] = $end ;
	echo "<script>window.location =  'adgroup.php?id=".$_GET['id']."&cid=".$_GET['cid']."&camp=".$_GET['camp']."';</script>";
	exit();
}	
         ...
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    <h2>AdGroups - <?php echo $_GET['camp']; ?></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li> &nbsp;
                      </li>
                      
                    </ul>
                    <form method="post" action="adgroup.php?id=<?php echo $_GET['id']; ?>&cid=<?php echo $_GET['cid']; ?>&camp=<?php echo $_GET['camp']; ?>">
                    <ul class="nav navbar-right panel_toolbox">
                      <li>Filter : &nbsp;
                      </li>
                      <li>
                  ...
                  <div class="x_content">
                  		<?php 
										...
										include 'download-adgroup.php';
										
										
										$rows = file('download/adgroup/adgroup_'.$_GET['id'].'.csv');
                                ...
                                <table id="datatable" class="table table-hover table-striped table-bordered">
                                    ...
                                    <?php foreach($csv as $csvData) { ?>
                                        <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><a href="loading.php?pg=ad-g.php?id=<?php echo $_GET['id']; ?>&cid=<?php echo $csvData[0]; ?>&camp=<?php echo $csvData[1]; ?>" target="_blank"  class="blue"><?php echo $csvData[1]; ?></td>
