...
if ( $_POST['url'] == 'https://keystonespaces.in/lp/') {

    $spreadsheetId = '1i7_w5BYn_jLB1MqMMG8_qmGNc-kWStBTBCAqaYrBOlk';
    ...
    $leadV = [[$name, $email, $ph, $form, $srd, $source, $medium, $campaign, $keyword,$term, $content, $formatted_date]];
