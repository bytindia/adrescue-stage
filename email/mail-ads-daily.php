...
$duration = '';
$subj_1 = "Facebook & Google Lead Ads Performance";
$mail_body_1 = "Team, <br/><br/> \n
PFA, Last 3 days - FB & Google Lead Ads Performance<br/><br/> \n
...
try {
	...
	$path_rep = $server_path.'daily-troubleshoot/';
	//echo $path_rep.''.$fileN; exit;
