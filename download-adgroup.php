...
class ParallelReportDownload
{
    ...
    public static function runExample(
        ...
        $selector->setFields(
            ['AdGroupId', 'AdGroupName', 'Ctr', 'Impressions', 'Clicks', 'Cost', 'AverageCost', 'AverageCpc', 'AverageCpm']
        );
    ...
    public static function main($ClientIds, $campaignId, $fromDt, $enDt)
    {
...
ParallelReportDownload::main($accIds, $campaignId, $fromDt, $enDt);
