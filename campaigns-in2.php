         ...
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    <h2><?php echo $cName; ?> - Campaigns</h2>
                  		...
                  		<?php 
                                ...
                                <table id="datatable" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
										...
										$valAcc = $linkedIn->get('v2/adCampaignsV2?q=search&search.account.values[0]=urn:li:sponsoredAccount:'.$_GET['id'].'&search.campaignGroup.values[0]=urn:li:sponsoredCampaignGroup:'.$_GET['cgid'].'&sort.field=ID&fields=id,name,objectiveType');
										foreach($valAcc['elements'] as $key => $v1) 
										{
											$cg_arr[$v1['id']] = $v1['name'];
										}
										
										$val = $linkedIn->get('v2/adAnalyticsV2?campaignGroups[0]=urn:li:sponsoredCampaignGroup:'.$_GET['cgid'].'&q=statistics&pivots[0]=CAMPAIGN&timeGranularity=ALL&fields=oneClickLeads,externalWebsiteConversions,likes,clicks,shares,totalEngagements,actionClicks,impressions,comments,dateRange,costInLocalCurrency,costInUsd,pivotValue&'.$stDt.''.$enDt);

//&objectiveType=LEAD_GENERATION,CREATIVE_ENGAGEMENT,WEBSITE_TRAFFIC,VIDEO_VIEW,BRAND_AWARENESS,WEBSITE_CONVERSION,WEBSITE_VISIT,ENGAGEMENT,JOB_APPLICANT
...
//exit;
										...
										if(count($val['elements'])>0) 
										{
											...
											{ 
												$cgId = str_replace("urn:li:sponsoredCampaign:", "", $rep['pivotValue']);
											?>
											<tr>
												<td><?php echo $i; ?></td>
												<td><a href="loading.php?pg=creative.php?id=<?php echo $_GET['id']; ?>&cgid=<?php echo $cgId; ?>&camp=<?php echo $cg_arr[$cgId]; ?>" target="_blank" class="blue"><?php echo  $cg_arr[$cgId]; ?></a></td>
