<style>
        ...
        .navbar-expand-md .navbar-nav { margin: 0 auto; font-size: 18px; }
...
<nav class="navbar navbar-expand-md navbar-dark fixed-top"  style="background: #357ebd;">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <li class="nav-item active">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="loading.php?pg=cron-adset-report.php?refresh=1&user_id=<?php echo $user_id; ?>">Fetch live Report</a>
                </li>
                <li class="nav-item">
