...
class ParallelReportDownload
{
    ...
    public static function runExample(
        ...
        $selector->setFields(
            ['CampaignId', 'CampaignName', 'Ctr', 'Impressions', 'Clicks', 'Cost']
        );
		...
		//$reportDefinition->ReturnMoneyMicros = false;
    ...
    public static function main($ClientIds, $accNames, $fromDt, $enDt)
    {
