...
$duration = '';
$subj_1 = "BYT - ".$clientN." - Audit Report ";
$mail_body_1 = "Hi, <br/><br/> \n
PFA, ".$clientN." - Audit Report<br/><br/> \n

Regards, <br/> \n
BYT Ads Report.

<br/><br/> \n
<span style='font-size:12px; color:#6F6E6E;'><b>Note:</b> This Email is automate system generated reports. For any queries / issues, please email to ads@bytindia.com.<span>
".$tbl;		
...
try {
	...
	//$to_address = "prabhu@bytindia.com";
	//$path_rep = '/home/faheems/webapps/adsninja/audit/pdf-files/';
	
	if(file_exists($pdf_path)) {
		
		 $mail->addAttachment($pdf_path);  		   // Add attachments
	}
