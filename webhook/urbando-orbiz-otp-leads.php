...
if (count($_POST) > 0 && $_POST['url'] == 'https://urbandokosmosorbiz.com/urbando-otp/') {

    $spreadsheetId = '1d112WU4ZcBy3PQOvl5Q7ZowI9acmHyaKsa7RQ_e6f_w';
    $sheetTab = 'Urbando-orbiz-otp';
    ...
    $leadV = [[$name, $email, $ph, $property, $source, $medium, $campaign,$keyword, $url, $formatted_date]];
