...
$dtQ = 'AND (created_time >='.(strtotime($_SESSION['stDt'])-34199).' AND created_time <='.((strtotime($_SESSION['enDt']) + 60*60*11)+12599).')'; 
                                ...
                                <table id="datatable" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>                                        	
                                            ...
                                            <td><?php echo $sqlROW['adsetN']; ?></td>
                                            <td><?php echo $sqlROW['adN']; ?></td>
