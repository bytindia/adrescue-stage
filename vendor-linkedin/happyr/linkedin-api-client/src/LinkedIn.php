...
class LinkedIn implements LinkedInInterface
{
    ...
    public function isAuthenticated()
    {
		...
		$user = $this->api('GET', 'v2/me?projection=(firstName,lastName,headline,id,emailAddress)', ['format' => 'json', 'response_data_type' => 'array']);
    ...
    public function api($method, $resource, array $options = [])
    {
		...
		//echo $method. '-'. $url. '-'. $options['headers']. '-'. $body; 
