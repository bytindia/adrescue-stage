...
if(isset($_GET['st'])) { 
  ...
  $ad_acc = array(
    ...
    376583790733205=>'Jain Housing - BYT CC',
    1246709765756836=>'Voora Oceans 27 New',
    427933624679014=>'Athens_BYT_New_CL',
    1744658879060018=>'Boulevard_BYT_New_CL',
    1196015513904250=>'Casagrand Southbrooke_BYT_CL',
    569001103516290=>'Casagrand_Arial_BYT_CL',
    462105354650207=>'Casagrand_Jubliant_CL',
    370327086813811=>'Firstcity_BYT_New_CL',
    807092046796106=>'Flagship_BYT_CL',
    735957617015640=>'PlatinumJoy_BYT_CL',
    834297526950773=>'Tudor_BYT_22_August 2022_New_CL',
    1317725875075405=>'Zenith_BYT_New_CL'
  );
  ...
  <?php
  $val = $acc_id;
  $url = "https://graph.facebook.com/".$api_ver."/act_".$val."/insights?level=adset&breakdowns=publisher_platform,device_platform,platform_position&fields=adset_id,adset_name,reach,impressions,spend,objective,actions&filtering=[{'field':'campaign.objective','operator':'IN','value':['LEAD_GENERATION']}]&time_range[since]=".date("Y-m-d", strtotime($dtRange1))."&time_range[until]=".date("Y-m-d", strtotime($dtRange2))."&access_token=".$access_token."&limit=750";
