       ...
       // echo "SELECT da.tbl_id, da.client_name, da.fb_id, da.g_id, da.in_id, da.ta_id, da.proj_name, da.name_contain, br.total_budget FROM dashboard_accounts da LEFT JOIN budget_reminder br ON da.bud_id = br.tbl_id WHERE da.tbl_id = '".mysqli_real_escape_string($conn, $clientId)."' AND da.uid='".$_SESSION['uid']."' AND da.delete_status=0"; 
        ...
        if($row) {
            $reportData[$clientId] = [
                ...
                'google_leads' => 0,
                'tooltip_html' => '',
                // Initialize T/Y/M fields
                'meta_spend_t' => 0, 'meta_leads_t' => 0,
                'meta_spend_y' => 0, 'meta_leads_y' => 0,
                'meta_spend_m' => 0, 'meta_leads_m' => 0,
                'instagram_spend_t' => 0, 'instagram_leads_t' => 0,
                'instagram_spend_y' => 0, 'instagram_leads_y' => 0,
                'instagram_spend_m' => 0, 'instagram_leads_m' => 0,
                'google_spend_t' => 0, 'google_leads_t' => 0,
                'google_spend_y' => 0, 'google_leads_y' => 0,
                'google_spend_m' => 0, 'google_leads_m' => 0
            ];
            //d($row); exit;
            // Get account IDs
            ...
            if(!empty($fb_acc_ids)) {
                ...
                // Initialize T/Y/M variables
                $meta_spend_t = $meta_spend_y = $meta_spend_m = 0;
                $meta_leads_t = $meta_leads_y = $meta_leads_m = 0;
                $insta_spend_t = $insta_spend_y = $insta_spend_m = 0;
                $insta_leads_t = $insta_leads_y = $insta_leads_m = 0;
            ...
            if(!empty($g_acc_ids)) {
                ...
                // Initialize Google T/Y/M variables
                $google_spend_t = $google_spend_y = $google_spend_m = 0;
                $google_leads_t = $google_leads_y = $google_leads_m = 0;
...
<body>
                    ...
                    <div class="card">
                        <div class="card-header" style="display:flex; justify-content: space-between; align-items: center; gap: 12px;">
                           ...
                           <div>
                             ...
                             <a href="#" id="toggleTY" class="btn btn-link btn-sm">Show Today/Yesterday</a>
                           </div>
                        </div>
                        <div class="card-body">
                            <div id="reportTable">
                                <!-- Consolidated view: default shows only selected date range (This Month). Today/Yesterday columns can be toggled. -->
                                <div id="tymTableContainer" style="margin-top:16px;">
  ...
  <thead>
    <tr>
      ...
      <th colspan="3" class="grp-meta">Meta</th>
      <th colspan="3" class="grp-google">Google</th>
      <th colspan="3" class="grp-total">Total</th>
    </tr>
    <tr>
      <th>Client</th>
      <th colspan="1" class="sub-meta-spend">Spend</th>
      <th colspan="1" class="sub-meta-leads">Leads</th>
      <th colspan="1" class="sub-meta-cpl">CPL</th>
      <th colspan="1" class="sub-google-spend">Spend</th>
      <th colspan="1" class="sub-google-leads">Leads</th>
      <th colspan="1" class="sub-google-cpl">CPL</th>
      <th colspan="1" class="sub-total-spend">Spend</th>
      <th colspan="1" class="sub-total-leads">Leads</th>
      <th colspan="1" class="sub-total-cpl">CPL</th>
    </tr>
    <tr>
      <th></th>
      <th class="col-t">T</th><th class="col-y">Y</th><th class="col-m">M</th>
      <th class="col-t">T</th><th class="col-y">Y</th><th class="col-m">M</th>
      <th class="col-t">T</th><th class="col-y">Y</th><th class="col-m">M</th>
      <th class="col-t">T</th><th class="col-y">Y</th><th class="col-m">M</th>
      <th class="col-t">T</th><th class="col-y">Y</th><th class="col-m">M</th>
  ...
  <tbody>
    <?php foreach($reportData as $clientId => $data):
        // Meta (Facebook) only
        $meta_spend_t = $data['meta_spend_t'] ?? 0;
        $meta_spend_y = $data['meta_spend_y'] ?? 0;
        $meta_spend_m = $data['meta_spend_m'] ?? 0;
        $meta_leads_t = $data['meta_leads_t'] ?? 0;
        $meta_leads_y = $data['meta_leads_y'] ?? 0;
        $meta_leads_m = $data['meta_leads_m'] ?? 0;
    ...
    <tr>
      ...
      <!-- Meta T/Y/M -->
      <td class="meta-col col-t"><?php echo moneyFormatIndia($meta_spend_t); ?></td>
      <td class="meta-col col-y"><?php echo moneyFormatIndia($meta_spend_y); ?></td>
      <td class="meta-col col-m"><?php echo moneyFormatIndia($meta_spend_m); ?></td>
      <td class="meta-col col-t"><?php echo moneyFormatIndia($meta_leads_t); ?></td>
      <td class="meta-col col-y"><?php echo moneyFormatIndia($meta_leads_y); ?></td>
      <td class="meta-col col-m"><?php echo moneyFormatIndia($meta_leads_m); ?></td>
      <td class="meta-col col-t"><?php echo moneyFormatIndia($meta_cpl_t); ?></td>
      <td class="meta-col col-y"><?php echo moneyFormatIndia($meta_cpl_y); ?></td>
      <td class="meta-col col-m"><?php echo moneyFormatIndia($meta_cpl_m); ?></td>
      <!-- Google T/Y/M -->
      <td class="google-col col-t"><?php echo moneyFormatIndia($google_spend_t); ?></td>
      <td class="google-col col-y"><?php echo moneyFormatIndia($google_spend_y); ?></td>
      <td class="google-col col-m"><?php echo moneyFormatIndia($google_spend_m); ?></td>
      <td class="google-col col-t"><?php echo moneyFormatIndia($google_leads_t); ?></td>
      <td class="google-col col-y"><?php echo moneyFormatIndia($google_leads_y); ?></td>
      <td class="google-col col-m"><?php echo moneyFormatIndia($google_leads_m); ?></td>
      <td class="google-col col-t"><?php echo moneyFormatIndia($google_cpl_t); ?></td>
      <td class="google-col col-y"><?php echo moneyFormatIndia($google_cpl_y); ?></td>
      <td class="google-col col-m"><?php echo moneyFormatIndia($google_cpl_m); ?></td>
      <!-- Total T/Y/M -->
      <td class="total-col col-t"><?php echo moneyFormatIndia($total_spend_t); ?></td>
      <td class="total-col col-y"><?php echo moneyFormatIndia($total_spend_y); ?></td>
      <td class="total-col col-m"><?php echo moneyFormatIndia($total_spend_m); ?></td>
      <td class="total-col col-t"><?php echo moneyFormatIndia($total_leads_t); ?></td>
      <td class="total-col col-y"><?php echo moneyFormatIndia($total_leads_y); ?></td>
      <td class="total-col col-m"><?php echo moneyFormatIndia($total_leads_m); ?></td>
      <td class="total-col col-t"><?php echo moneyFormatIndia($total_cpl_t); ?></td>
      <td class="total-col col-y"><?php echo moneyFormatIndia($total_cpl_y); ?></td>
      <td class="total-col col-m"><?php echo moneyFormatIndia($total_cpl_m); ?></td>
    </tr>
    <?php endforeach; ?>
  </tbody>

  <?php 
  // Calculate grand totals for T/Y/M
  $grand_meta_spend_t = $grand_meta_spend_y = $grand_meta_spend_m = 0;
  $grand_meta_leads_t = $grand_meta_leads_y = $grand_meta_leads_m = 0;
  $grand_google_spend_t = $grand_google_spend_y = $grand_google_spend_m = 0;
  $grand_google_leads_t = $grand_google_leads_y = $grand_google_leads_m = 0;
  
  foreach($reportData as $clientId => $data) {
      $grand_meta_spend_t += $data['meta_spend_t'] ?? 0;
      $grand_meta_spend_y += $data['meta_spend_y'] ?? 0;
      $grand_meta_spend_m += $data['meta_spend_m'] ?? 0;
      $grand_meta_leads_t += $data['meta_leads_t'] ?? 0;
      $grand_meta_leads_y += $data['meta_leads_y'] ?? 0;
      $grand_meta_leads_m += $data['meta_leads_m'] ?? 0;
      $grand_google_spend_t += $data['google_spend_t'] ?? 0;
      $grand_google_spend_y += $data['google_spend_y'] ?? 0;
      $grand_google_spend_m += $data['google_spend_m'] ?? 0;
      $grand_google_leads_t += $data['google_leads_t'] ?? 0;
      $grand_google_leads_y += $data['google_leads_y'] ?? 0;
      $grand_google_leads_m += $data['google_leads_m'] ?? 0;
  }
  
  $grand_total_spend_t = $grand_meta_spend_t + $grand_google_spend_t;
  $grand_total_spend_y = $grand_meta_spend_y + $grand_google_spend_y;
  $grand_total_spend_m = $grand_meta_spend_m + $grand_google_spend_m;
  $grand_total_leads_t = $grand_meta_leads_t + $grand_google_leads_t;
  $grand_total_leads_y = $grand_meta_leads_y + $grand_google_leads_y;
  $grand_total_leads_m = $grand_meta_leads_m + $grand_google_leads_m;
  ?>
  
  <?php if($grand_meta_spend_m > 0 || $grand_google_spend_m > 0) { ?>
  <tfoot>
    <tr class="total-row">
      <td class="client-col" style="text-align:center;"><b>TOTAL</b></td>
      <!-- Meta T/Y/M -->
      <td class="meta-col col-t"><?php echo moneyFormatIndia($grand_meta_spend_t); ?></td>
      <td class="meta-col col-y"><?php echo moneyFormatIndia($grand_meta_spend_y); ?></td>
      <td class="meta-col col-m"><?php echo moneyFormatIndia($grand_meta_spend_m); ?></td>
      <td class="meta-col col-t"><?php echo moneyFormatIndia($grand_meta_leads_t); ?></td>
      <td class="meta-col col-y"><?php echo moneyFormatIndia($grand_meta_leads_y); ?></td>
      <td class="meta-col col-m"><?php echo moneyFormatIndia($grand_meta_leads_m); ?></td>
      <td class="meta-col col-t"><?php echo moneyFormatIndia(($grand_meta_leads_t > 0) ? round($grand_meta_spend_t / $grand_meta_leads_t) : 0); ?></td>
      <td class="meta-col col-y"><?php echo moneyFormatIndia(($grand_meta_leads_y > 0) ? round($grand_meta_spend_y / $grand_meta_leads_y) : 0); ?></td>
      <td class="meta-col col-m"><?php echo moneyFormatIndia(($grand_meta_leads_m > 0) ? round($grand_meta_spend_m / $grand_meta_leads_m) : 0); ?></td>
      <!-- Google T/Y/M -->
      <td class="google-col col-t"><?php echo moneyFormatIndia($grand_google_spend_t); ?></td>
      <td class="google-col col-y"><?php echo moneyFormatIndia($grand_google_spend_y); ?></td>
      <td class="google-col col-m"><?php echo moneyFormatIndia($grand_google_spend_m); ?></td>
      <td class="google-col col-t"><?php echo moneyFormatIndia($grand_google_leads_t); ?></td>
      <td class="google-col col-y"><?php echo moneyFormatIndia($grand_google_leads_y); ?></td>
      <td class="google-col col-m"><?php echo moneyFormatIndia($grand_google_leads_m); ?></td>
      <td class="google-col col-t"><?php echo moneyFormatIndia(($grand_google_leads_t > 0) ? round($grand_google_spend_t / $grand_google_leads_t) : 0); ?></td>
      <td class="google-col col-y"><?php echo moneyFormatIndia(($grand_google_leads_y > 0) ? round($grand_google_spend_y / $grand_google_leads_y) : 0); ?></td>
      <td class="google-col col-m"><?php echo moneyFormatIndia(($grand_google_leads_m > 0) ? round($grand_google_spend_m / $grand_google_leads_m) : 0); ?></td>
      <!-- Total T/Y/M -->
      <td class="total-col col-t"><?php echo moneyFormatIndia($grand_total_spend_t); ?></td>
      <td class="total-col col-y"><?php echo moneyFormatIndia($grand_total_spend_y); ?></td>
      <td class="total-col col-m"><?php echo moneyFormatIndia($grand_total_spend_m); ?></td>
      <td class="total-col col-t"><?php echo moneyFormatIndia($grand_total_leads_t); ?></td>
      <td class="total-col col-y"><?php echo moneyFormatIndia($grand_total_leads_y); ?></td>
      <td class="total-col col-m"><?php echo moneyFormatIndia($grand_total_leads_m); ?></td>
      <td class="total-col col-t"><?php echo moneyFormatIndia(($grand_total_leads_t > 0) ? round($grand_total_spend_t / $grand_total_leads_t) : 0); ?></td>
      <td class="total-col col-y"><?php echo moneyFormatIndia(($grand_total_leads_y > 0) ? round($grand_total_spend_y / $grand_total_leads_y) : 0); ?></td>
      <td class="total-col col-m"><?php echo moneyFormatIndia(($grand_total_leads_m > 0) ? round($grand_total_spend_m / $grand_total_leads_m) : 0); ?></td>
    </tr>
  </tfoot>
  <?php } ?>
                                </table>
  ...
  <?php } ?>
    ...
    var dtCombined = null; // not used (first table removed)
    var dtSplit = null;    // not used (separate insta table hidden by default)
    var dtTYM = null;

    // Combined table removed

    // Split table kept but not used by default

    function initTYMIfNeeded() {
        // Temporarily disable DataTables to fix column visibility issues
        console.log('DataTables disabled for debugging');
        /*
    ...
    function initSplitIfNeeded() {
        // Temporarily disable DataTables to fix column visibility issues
        console.log('DataTables disabled for split table debugging');
        /*
    ...
    // Init default visible table: T/Y/M by default
    initTYMIfNeeded();
    // Hide Today/Yesterday and Instagram columns by default (headers + body)
    function hideOptionalCols() {
        $('.col-t, .col-y').removeClass('show');
        console.log('Hiding Today/Yesterday columns');
        // DataTables disabled for debugging
        // if (dtTYM) { dtTYM.columns.adjust().draw(false); }
    }
    function showTYCols(show) {
        console.log('showTYCols called with:', show);
        if (show) {
            // Add show class to make columns visible
            $('.col-t, .col-y').addClass('show');
            // Update colspans to 3 when showing T/Y columns
            $('.sub-meta-spend, .sub-meta-leads, .sub-meta-cpl, .sub-google-spend, .sub-google-leads, .sub-google-cpl, .sub-total-spend, .sub-total-leads, .sub-total-cpl').attr('colspan', '3');
            $('.grp-meta, .grp-google, .grp-total').attr('colspan', '9');
            console.log('Showing T/Y columns - colspans updated');
            console.log('Visible T/Y columns:', $('.col-t.show, .col-y.show').length);
        } else {
            // Remove show class to hide columns
            $('.col-t, .col-y').removeClass('show');
            // Update colspans to 1 when hiding T/Y columns
            $('.sub-meta-spend, .sub-meta-leads, .sub-meta-cpl, .sub-google-spend, .sub-google-leads, .sub-google-cpl, .sub-total-spend, .sub-total-leads, .sub-total-cpl').attr('colspan', '1');
            $('.grp-meta, .grp-google, .grp-total').attr('colspan', '3');
            console.log('Hiding T/Y columns - colspans updated');
            console.log('Hidden T/Y columns:', $('.col-t:not(.show), .col-y:not(.show)').length);
        }
    }
    // Instagram temporarily removed
    hideOptionalCols();
    ...
    // Toggle Today/Yesterday columns in the same table
    $('#toggleTY').on('click', function (e) {
        e.preventDefault();
        console.log('Toggle clicked');
        var tyHidden = ($('.col-t.show').length === 0) && ($('.col-y.show').length === 0);
        console.log('TY hidden:', tyHidden);
        if (tyHidden) {
            showTYCols(true);
            $(this).text('Hide Today/Yesterday');
            console.log('Button text changed to: Hide Today/Yesterday');
        } else {
            showTYCols(false);
            $(this).text('Show Today/Yesterday');
            console.log('Button text changed to: Show Today/Yesterday');
        }
    });

    // Toggle Instagram split view (like multi-client.php)
    ...
    // Removed separate Yesterday/This Month toggle (now inside the table columns)

    // When date range is changed: default to Month-only (hide T/Y) and show combined view
    $('#reportrange').on('apply.daterangepicker', function(ev, picker) {
        $('#tymTableContainer').show();
        $('#splitTableContainer').hide();
        showTYCols(false);
        $('#toggleTY').text('Show Today/Yesterday');
        $('#toggleInsta').text('Show Instagram report');
        initTYMIfNeeded();
    });
});
    </script>
