...
$statement = " cashflow WHERE uid='".$_SESSION['uid']."' AND delete_status=0";
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li>
                        <div class="btn-group  btn-group-sm">
                        	<a href="loading.php?pg=cashflow-add.php"  class="btn btn-success btn-sm">Add Accounts</a>                        
                      </div>    
                      </li>
                      <li> &nbsp;
                      </li>
                      <li>
                        <div class="btn-group  btn-group-sm">
                        	<a href="loading.php?pg=cron-cashflow.php?refresh=1"  class="btn btn-warning btn-sm" onclick="return confirm('Are you sure you want to Email Cashflow report?');" ><i class="fa fa-refresh"></i> Refresh All</a>                        
                      </div>    
                      </li>
                    </ul>
                    ...
                    $grandRecived = $grandSpent = $grandBalance = 0;
                      ...
                      $grandBalance = $grandBalance + $tot_bal;
                                        ...
                                        <tr>                                        	
                                        	...
                                        	<td><a onClick="onAjax(<?php echo $sqlROW["tbl_id"]; ?>, 2, '<?php echo $sqlROW["client_name"]; ?> - Payment Received Detail');" data-id="1" data-toggle="modal" class="blue modal-cl" data-target=".bs-example-modal-lg"> <?php echo money_format('%.0n', $sqlROW["tot_paid"]); ?></a></td>                                         
                                            ...
                                            <td>
                                            <a href="loading.php?pg=cron-cashflow.php?tbl_id=<?php echo $sqlROW["tbl_id"]; ?>&refresh=1" class="btn btn-warning btn-sm"><i class="fa fa-refresh"></i></a>
                                            <a href="loading.php?pg=cashflow-add.php?id=<?php echo $sqlROW["tbl_id"]; ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i> </a>
                                    <a href="loading.php?pg=cashflow.php?del=<?php echo $sqlROW["tbl_id"]; ?>" onclick="return confirm('Are you sure you want to delete this?');"  class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
