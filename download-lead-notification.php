...
class ParallelReportDownload
{
    ...
    public static function runExample(
        ...
        $selector->setFields(
            ['AccountDescriptiveName', 'AverageCpc', 'AccountCurrencyCode', 'Impressions', 'Clicks', 'Cost', 'AverageCost', 'AverageCpm', 'CostPerConversion', 'Ctr', 'Conversions']
        );
...
ParallelReportDownload::main($accIds, $fromDt, $enDt, 1, $g_mcc, $g_refresh_token, $server_path);

ParallelReportDownload::main($accIds, $fromDt2, $enDt2, 2, $g_mcc, $g_refresh_token, $server_path);
