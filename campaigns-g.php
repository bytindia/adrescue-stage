...
if(isset($_POST['dt_submit'])){
	...
	$_SESSION['stDt'] = $start ;
	$_SESSION['enDt'] = $end ;
	echo "<script>window.location =  'campaigns-g.php?id=".$_GET['id']."';</script>";
	exit();
}	
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    ...
                    <form method="post" action="campaigns-g.php?id=<?php echo $_GET['id']; ?>">
                    <ul class="nav navbar-right panel_toolbox">
                      <li>Filter : &nbsp;
                      </li>
                      <li>
                  ...
                  <div class="x_content">
                  		<?php 
										...
										include 'download-campaign.php';
										
										
										$rows = file('download/adgroup_'.$_GET['id'].'.csv');
                                ...
                                <table id="datatable" class="table table-hover table-striped table-bordered">
                                    ...
                                    <?php foreach($csv as $csvData) { ?>
                                        <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><a href="loading.php?pg=adgroup.php?id=<?php echo $_GET['id']; ?>&cid=<?php echo $csvData[0]; ?>&camp=<?php echo $csvData[1]; ?>" target="_blank"  class="blue"><?php echo $csvData[1]; ?></a></td>
