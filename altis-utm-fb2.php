...
$sql_g = "SELECT COUNT(*) as tot,source,campaign,cq_id FROM `sales_ninja` WHERE cId=12 $extQry AND source LIKE '%face%' GROUP BY  CASE WHEN campaign IS NULL OR campaign = '' THEN '' ELSE campaign END,CASE WHEN cq_id IS NULL OR cq_id = '' THEN '' ELSE cq_id END   order by cq_id desc";
...
<ul class="nav navbar-right panel_toolbox">
                    ...
                    <h4>Altis - Status Vs Campaign wise report (Facebook)</h4>
