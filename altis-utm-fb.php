...
$sql_g = "SELECT COUNT(*) as tot,source,campaign,cq_id FROM `sales_ninja` WHERE cId=12 AND source LIKE '%face%' GROUP BY campaign,cq_id order by cq_id desc";
