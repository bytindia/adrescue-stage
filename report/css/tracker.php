...
$timeArr2 = array(
    0=>"$curTime:00 to $curTime:59",
    1=>"$curTime_1:00 to $curTime_1:59",
    2=>"$curTime_2:00 to $curTime_2:59",
    3=>"$curTime_3:00 to $curTime_3:59"
);
...
if(isset($_SESSION['st'])) { 
 ...
 //$ad_acc = array( 807092046796106=>'Flagship',1744658879060018=>'Boulevard');
  ...
  $src_text = array(
    ...
    <a class="btn btn-danger" href="loading.php?pg=spend-casa2.php" style="background-color: #17a106; border: 2px solid #22bb0f">Budget</a>
    <?php } ?>
    <a class="btn btn-default float-right" href="logout.php?placement">Logout</a>
    </div>
