...
if (count($_POST) > 0 && $_POST['url'] == 'https://rwdvistamarbella.com/') {

    $spreadsheetId = '14qdXrkx2xCpkGHYcfaEEPs9VQp3Qy9HIF7UNUk0Vuvg';
    $sheetTab = 'Rwd-LP Leads';
    ...
    $leadV = [[$name, $email, $ph, $source, $project, $formatted_date]];
