...
Auth();
$pgHeadline = 'Campaign Groups Reports';
$pgID = 2;
$err =''; 
...
if(isset($_POST['dt_submit'])){
	...
	$_SESSION['stDt'] = $start ;
	$_SESSION['enDt'] = $end ;
	echo "<script>window.location =  'campaigns.php?id=".$_GET['id']."';</script>";
	exit();
}	
include 'config.php';
         ...
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    <h2><?php echo $cName; ?> - Campaign Groups </h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li> &nbsp;
                      </li>
                      
                    </ul>
                    <form method="post" action="campaigns.php?id=<?php echo $_GET['id']; ?>">
                    <ul class="nav navbar-right panel_toolbox">
                      <li>Filter : &nbsp;
                      </li>
                      <li>
                  		...
                  		<?php 
                                ...
                                <table id="datatable" class="table table-hover table-striped table-bordered">
                                    ...
                                    <tbody>
										...
										$cg_arr = array();		
										$val['elements'] = array();
										//$valTest = $linkedIn->get('v2/adForms?q=account&account=urn:li:sponsoredAccount:'.$_GET['id'].'&totals=true&count=1&start=0');
										
										/*$postVal = array(
											'key' => array('developerApplication'=>'urn:li:developerApplication:5426315', 'sponsoredEntity'=>'urn:li:sponsoredAccount:504389587' ),
											'status' => 'ACTIVE',
											'url' => 'https://stage.adrescue.in/webhooks-in.php'
										);
										
										$valTest = $linkedIn->post('v2/leadNotificationUrls', $postVal);
										
										//v2/leadNotificationUrls/sponsoredEntity=urn:li:sponsoredAccount:'.$_GET['id'].'&developerApplication=urn:li:developerApplication:5426315&url=https://stage.adrescue.in/webhooks-in.php&status=ACTIVE');
										
										d($valTest); exit;*/
										
										$valAcc = $linkedIn->get('v2/adCampaignGroupsV2?q=search&search.account.values[0]=urn:li:sponsoredAccount:'.$_GET['id'].'&sort.field=ID&fields=id,name');
										foreach($valAcc['elements'] as $key => $v1) 
										{
											$cg_arr[$v1['id']] = $v1['name'];
										}
										
										$val = $linkedIn->get('v2/adAnalyticsV2?accounts[0]=urn:li:sponsoredAccount:'.$_GET['id'].'&q=analytics&pivot=CAMPAIGN_GROUP&timeGranularity=ALL&fields=oneClickLeads,externalWebsiteConversions,likes,clicks,shares,totalEngagements,actionClicks,impressions,comments,dateRange,costInLocalCurrency,costInUsd,pivotValue&'.$stDt.''.$enDt);
...
//exit;
										...
										if(count($val['elements'])>0) 
										{
											...
											{ 
												$cgId = str_replace("urn:li:sponsoredCampaignGroup:", "", $rep['pivotValue']);
											?>
											<tr>
												<td><?php echo $i; ?></td>
												<td><a href="loading.php?pg=campaigns-in2.php?id=<?php echo $_GET['id']; ?>&cgid=<?php echo $cgId; ?>&camp=<?php echo $cg_arr[$cgId]; ?>" target="_blank" class="blue"><?php echo  $cg_arr[$cgId]; ?></a></td>
