...
$html .= '<link rel="stylesheet" type="text/css" href="/assets2/css/bootstrap.css">
									...
									$ans  = $sqlROW;
										...
										{ 
										  ...
										  if($rowCount % $numOfCols == 0) { $html .= '<div class="row">'; } 
											...
											$html .= ' 
                                                <div class="col-xl-6 col-lg-6 col-xs-6" id="r'.($k+1).'">
                                                    <div class="card">
                                                        <div class="card-body">
                          ...
                          <div class="span9">'; 
							if(count($Recom_list)>0) {
								...
								foreach($Recom_list as $k => $v) {
									$html .=  '<a href="#r'.$k.'" class="list-group-item list-group-item-action">'.$k.'. '.$v.'</a>';
								}
								$html .= '</div>';
							}
