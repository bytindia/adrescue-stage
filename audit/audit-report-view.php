              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title1 text-center">
                  	<!--<a href="index.php"><img src="images/ads-rescue.png" height="250" > </a>-->
                                                            ...
                                                            <div class="card-block">
                                                                <div class="media">
                                                                    <div class="media-body text-xs-left">
                                                                        <h5><?php echo ($k+1).'. '.$v; ?> <i data-toggle="tooltip" data-placement="top" title="Status of the Ad Account" class="fa fa-info-circle" aria-hidden="true"></i></h5>
												  ...
												  <div class="label">			    
													...
													<div>
														<div class="profile">
															...
															<div class="score"><span>85</span>/100</div>
														</div>
...
<script>
updateDonutChart('#specificChart', 85, true);
