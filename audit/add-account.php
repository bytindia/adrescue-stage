...
if(isset($_POST['submit'])){
	...
	if($_POST['acc_id']!='' && $_POST['page_id']!='') {
		...
		$pg_cont = file_get_contents('https://graph.facebook.com/'.$api_ver.'/'.$_POST['page_id'].'/picture?redirect=0&type=large');
                  ...
                  <div class="x_content">
                  		<?php 
									...
									if(isset($_GET['id'])) {
										...
										echo "SELECT * FROM audit_pages WHERE uid='".$_SESSION['uid']."' and admin_delete='0' order by pg_name asc"; 
                                    ...
                                    <div class="container-fluid">
                                      <div class="row">		
                                                ...
                                                <div class="col-md-8">     
                                                 ...
                                                 <a href="index.php" class="btn btn-default btn-lg" style="width: 120px; height: 60px; font-size: 25px;"> Cancel</a> 
                                                 <br />
                                                </div>
                                        </div>
                                    </div>
