...
if(isset($_GET['id'])) {
  echo 'Loading...';
    ...
    $row = mysqli_fetch_assoc($cirRes);
		...
		$_SESSION['logged'] = 1;
    echo "<script>window.location = 'spend-casa.php';</script>";
		exit();	
	}  else {
...
if(isset($_POST['submit'])) {
  ...
  if($uname == 'casa' && ($pw=='Bte6g#RTg' || $pw=='9930')){
      $_SESSION['client'] = 'casa';
      if($pg=='') { $pg = 'spend-casa.php'; }
...
<html lang="en">
  <head>
    ...
    <title>CasaGrand - Ads dashboard</title>
  ...
  <body class="login">
    ...
    <img src="images/Casagrand-Logo1.png" alt="CasaGrand" height="40" >
  </div>
