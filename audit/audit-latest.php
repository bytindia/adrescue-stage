...
.title-card { background: #337ab7; color: white; }
...
/* Meta Ad Account Selector Styles - Matching adv-targeting.php */
...
<div class="container mt-3">
    <!-- Header with title on left and selection on right -->
    <div class="row align-items-center mb-3">
        <div class="col-md-6">
            <h5 class="mb-0"><?php echo $acc_info['name'] ?? ""; ?>  Audit Report</h5>
        </div>
        <div class="col-md-6 text-end">
            <select class="form-control" id="actSelect" style="display: inline-block; width: auto; min-width: 250px;">
                ...
                if(!empty($unique_fb_accounts)) {
                    foreach($unique_fb_accounts as $account_id) {
                        ...
                        $selected = ($account_id == $fbId) ? 'selected' : '';
    ...
    <!-- Audit Results - Only show when act parameter is present -->
    <div class="card">
    ...
    <?php else: ?>
    <!-- No account selected - Show instruction message 
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body text-center">
                    
                    <p class="text-muted">Select a Meta Ad Account above to view the audit report</p>
                </div>
            </div>
        </div>
    </div>-->
...
<script type="text/javascript">
    ...
    <?php endif; ?>
    <!-- End of Audit Results JavaScript -->
...
<script>
    $(document).ready(function() {
        // Auto-redirect when account is selected
        $('#actSelect').on('change', function() {
            var selectedAccount = $(this).val();
            if (selectedAccount && selectedAccount !== '') {
                // Redirect to loading.php with the audit page and act parameter
                var redirectUrl = 'loading.php?pg=audit-latest.php&act=' + selectedAccount;
