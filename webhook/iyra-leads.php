...
if (count($_POST) > 0 && $_POST['phone'] != '') {
    ...
    if ($_POST['project'] == 'iYRA Amara') { 
        $spreadsheetId = '1yB1LDehmnZ3JZLW4cOGpEw962tjQe8L5qq2CZv7F1nw';
        $sheetTab = 'Google Lead';
        $accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiR3JhbmRNYWdudW0iLCJlbWFpbCI6InByZWV0aGlAZ21haWwuY29tIiwiaWF0IjoxNzE5NDEzOTE1fQ.vhNBM31Sbxew9S9qZt1cHyd2nOyVS-sTKq5IRpzZ8vw";
        $project_key = '48d64-0f64f-a34f1-5a179-235cdd7d760e'; 
    } else {
        $spreadsheetId = '1ib0T9Pf8iSpTTanv7bWcJ9U9sEw94HgK_yLNZynKnfg';
        $sheetTab = 'Google Lead';
        $accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiR3JhbmRNYWdudW0iLCJlbWFpbCI6InByZWV0aGlAZ21haWwuY29tIiwiaWF0IjoxNzE5NDEzOTE1fQ.vhNBM31Sbxew9S9qZt1cHyd2nOyVS-sTKq5IRpzZ8vw";
        $project_key = 'c8956-a8307-414fc-29395-c78f60145932'; 
    }
    ...
    // Prepare POST body (x-www-form-urlencoded)
