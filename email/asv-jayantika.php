...
try {
	...
	$emailIds = "kumartolia@asvconstructions.com,bytramesh@gmail.com,abarnabyt@gmail.com";
	if($emailIds!='') { $to_address = $emailIds; } else { $to_address = "kumartolia@asvconstructions.com,bytramesh@gmail.com,abarnabyt@gmail.com"; }
