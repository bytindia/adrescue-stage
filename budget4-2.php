...
Auth();
$pgHeadline = 'Ads Budget - detailed report (last month)';
$pgID = 8;
$err =''; 
...
if(isset($_GET['del'])) {
	mysqli_query($conn, "UPDATE budget_reminder_last_mon  SET delete_status='1' where tbl_id=".$_GET['del']."");
...
if(isset($_POST['submit_hide'])) {
        ...
        $cirSql = "UPDATE budget_reminder_last_mon  SET hide_temp='1' WHERE tbl_id IN (".implode(',',$_POST['tbl_id']).")";
...
if(isset($_POST['submit_show'])) {
  // $extQ = ' AND tbl_id IN ('.implode(",",$_POST['tbl_id']).')';
  $cirSql = "UPDATE budget_reminder_last_mon  SET hide_temp='0' WHERE tbl_id IN (".implode(',',$_POST['tbl_id']).")";
  mysqli_query($conn, $cirSql) or die(mysqli_error()); 
  echo "<script>window.location = 'budget4-2.php';</script>";
}
...
$statement = " budget_reminder_last_mon _last_mon  WHERE uid='".$_SESSION['uid']."' AND delete_status=0";
...
tr th {
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li>
                        <div class="btn-group  btn-group-sm">
                        	<a href="budget4-2.php?hide=1"  class="btn btn-default btn-sm">Hidden Accounts</a>                        
                      </div>    
                      </li>
                      </li>
                      <li> &nbsp;
                      ...
                      <li>
                        <div class="btn-group  btn-group-sm">
                        	<a href="loading.php?pg=cron-budget4-2.php?refresh=1"  class="btn btn-warning btn-sm" onclick="return confirm('Are you sure you want to Email Cashflow report?');" ><i class="fa fa-refresh"></i> Refresh All</a>                        
                      </div>    
                      </li>
                    </ul>
                                        ...
                                        <tr>                                        	
                                           ...
                                           <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li><a href="loading.php?pg=cron-budget4-2.php?tbl_id=<?php echo $sqlROW["tbl_id"]; ?>&refresh=1">Refresh</a></li>
                                                    <li><a href="loading.php?pg=budget-add.php?id=<?php echo $sqlROW["tbl_id"]; ?>">Edit</a></li>
                                                    <li><a href="loading.php?pg=budget4-2.php?del=<?php echo $sqlROW["tbl_id"]; ?>" onclick="return confirm('Are you sure you want to delete this?');" >Delete</a></li>
                                                </ul>
                                            </div> 
                                           ...
                                           <a href="loading.php?pg=cron-budget4-2.php?tbl_id=<?php echo $sqlROW["tbl_id"]; ?>&refresh=1" ><i class="fa fa-refresh" data-html="true" data-toggle="tooltip" data-original-title="Refresh"></i></a>--> </td>                                      
  ...
  <?php
                    ...
                    ?>                                      
                                ...
                                <a href="budget4-2.php" class="btn btn-default">Reset</a> <input type="submit" name="submit" value="Submit" class="btn btn-primary"> 
