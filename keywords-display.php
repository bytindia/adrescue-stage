...
if(isset($_POST['dt_submit'])){
	...
	$_SESSION['stDt'] = $start ;
	$_SESSION['enDt'] = $end ;
	echo "<script>window.location =  'keywords-display.php?id=".$_GET['id']."';</script>";
	exit();
}	
         ...
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    <h2><?php echo $cName; ?> - Display Keywords</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li> &nbsp;
                      </li>
                      
                    </ul>
                    <form method="post" action="keywords-display.php?id=<?php echo $_GET['id']; ?>">
                    <ul class="nav navbar-right panel_toolbox">
                      <li>Filter : &nbsp;
                      </li>
                      <li>
                  ...
                  <div class="x_content">
                  		<?php 
										...
										include 'download-keywords-display.php';
										
										
										$rows = file('download/keywords-display/adgroup_'.$_GET['id'].'.csv');
										$_SESSION['row'] = $rows;
										$rows = $_SESSION['row'];
                                ...
                                <table id="datatable" class="table table-hover table-striped table-bordered">
                                    ...
                                    <?php foreach($csv as $csvData) { ?>
                                        <tr>
                                                    ...
                                                    <td><?php echo @round($csvData[11]/1000000);  ?></td>
