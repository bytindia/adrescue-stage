...
<div class="right_col" role="main">
    <div class="row" style="margin-right: 0px; margin-bottom: 10px;">
        ...
        <?php if(count($fb_acc_ids)>0) { ?>| <a href="facebook.php" target="_top">Facebook</a> <?php } ?>
        <?php if(count($g_acc_ids)>0) { ?>| <a href="google.php" target="_top">Google</a> <?php } ?>
        <?php if(count($in_acc_ids)>0) { ?>| <a href="linkedin.php" target="_top">LinkedIn</a> <?php } ?>
        <?php if(count($ta_acc_ids)>0) { ?>| <a href="taboola.php" target="_top">Taboola</a> <?php } ?>
