...
class ParallelReportDownload
{
    ...
    public static function runExample(
        ...
        $selector->setFields(           
			 ['CampaignId', 'CampaignName', 'AverageCpc', 'Impressions', 'Clicks', 'Cost', 'AverageCost', 'AverageCpm', 'CostPerConversion', 'Ctr', 'Conversions','BounceRate', 'AverageTimeOnSite', 'CampaignStatus', 'Date']
        );
...
$fromDt = date('Ymd', strtotime($last90));
$enDt = date('Ymd', strtotime($today));
ParallelReportDownload::main($accIds, $fromDt, $enDt, $g_mcc, $g_refresh_token, $server_path);