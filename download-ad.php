...
class ParallelReportDownload
{
    ...
    public static function runExample(
        ...
        $selector->setFields(
            ['Id', 'AdGroupName', 'Ctr', 'Impressions', 'Clicks', 'Cost', 'AverageCost', 'AverageCpc', 'AverageCpm']
        );
        ...
        $reportDefinition->setReportName('Custom AD_PERFORMANCE_REPORT');
    ...
    public static function main($ClientIds, $adgroupId, $fromDt, $enDt)
    {
...
ParallelReportDownload::main($accIds, $adgroupId, $fromDt, $enDt);
