...
class ParallelReportDownload
{
    ...
    public static function runExample(
        ...
        $selector->setFields(
            ['CampaignId', 'CampaignName', 'Ctr', 'Impressions', 'Clicks', 'Cost', 'AverageCost', 'AverageCpc', 'AverageCpm', 'Criteria', 'AdGroupName',  'CostPerConversion']
        );
        ...
        $reportDefinition->setReportName('Custom DISPLAY_KEYWORD_PERFORMANCE_REPORT');
