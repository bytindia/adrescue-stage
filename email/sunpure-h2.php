...
//$leadV = [[$_POST['name'],$_POST['email'],$_POST['mobile'],$_POST['form_name'],$_POST['source'],'LP', date('d-m-Y, h:i a')]];
//append_to_sheet(2,1, $leadV,$spreadsheetId,$sheetTab);

echo 1; 
//Load Composer's autoloader

$mailer_name_leads = "H2 LP Enquiry";
...
try {
	...
	$emailIds = "shalu@bytindia.com";
	if($emailIds!='') { $to_address = $emailIds; } else { $emailIds =  "shalu@bytindia.com"; }
    ...
    $mail->Subject = 'Sunpure H2 - LP Enquiry';
