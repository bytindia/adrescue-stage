...
Auth();
$pgHeadline = 'Cashflow - Add Accounts';
$pgID = 8;
$err =''; 
...
if(isset($_POST['submit'])){
	...
	if($_POST['client']!='') {
		...
		if(isset($_GET['id'])) {
				$cirSql = "UPDATE cashflow SET client_name='".mysqli_real_escape_string($conn, $_POST['client'])."', email='".mysqli_real_escape_string($conn, $_POST['email'])."', daily_budget='".mysqli_real_escape_string($conn, $_POST['daily_budget'])."', fb_id='".mysqli_real_escape_string($conn, $_POST['fb_acc'])."',  fb_received='".mysqli_real_escape_string($conn, $_POST['fb_received'])."', fb_stDt='".mysqli_real_escape_string($conn, $_POST['date_fb'])."', g_id='".mysqli_real_escape_string($conn, $_POST['g_acc'])."',  g_stDt='".mysqli_real_escape_string($conn, $_POST['date_g'])."', in_id='".mysqli_real_escape_string($conn, $_POST['in_acc'])."',  in_stDt='".mysqli_real_escape_string($conn, $_POST['date_in'])."', ta_id='".mysqli_real_escape_string($conn, $_POST['ta_acc'])."',  ta_stDt='".mysqli_real_escape_string($conn, $_POST['date_ta'])."', tot_paid=".$tot_received.", tot_penalty=".$p_tot_received.", updated=now() WHERE tbl_id=".$_GET['id']."";
				mysqli_query($conn, $cirSql) or die(mysqli_error()); 
				$lastId = $_GET['id'];
		} else {
			  $cirSql = "INSERT INTO cashflow (uid, client_name, email, daily_budget, fb_id, fb_received, fb_stDt, g_id, g_stDt, in_id, in_stDt, ta_id, ta_stDt, tot_paid, tot_penalty, created, updated) VALUES ('".$_SESSION['uid']."', '".mysqli_real_escape_string($conn, $_POST['client'])."', '".mysqli_real_escape_string($conn, $_POST['email'])."', '".mysqli_real_escape_string($conn, $_POST['daily_budget'])."', '".mysqli_real_escape_string($conn, $_POST['fb_acc'])."', '".mysqli_real_escape_string($conn, $_POST['fb_received'])."', '".mysqli_real_escape_string($conn, $_POST['date_fb'])."', '".mysqli_real_escape_string($conn, $_POST['g_acc'])."', '".mysqli_real_escape_string($conn, $_POST['date_g'])."', '".mysqli_real_escape_string($conn, $_POST['in_acc'])."', '".mysqli_real_escape_string($conn, $_POST['date_in'])."', '".mysqli_real_escape_string($conn, $_POST['ta_acc'])."', '".mysqli_real_escape_string($conn, $_POST['date_ta'])."', ".$tot_received.", ".$p_tot_received.", now(), now());"; 
			 mysqli_query($conn, $cirSql) or die(mysqli_error());
                  ...
                  <div class="x_content">
                  		<?php 
									...
									if(isset($_GET['id'])) {
										...
										$sqlD=mysqli_query($conn, "SELECT c.client_name, c.email, c.daily_budget, c.fb_id, c.fb_stDt, c.fb_received, c.g_id, c.g_stDt, c.in_id, c.in_stDt, c.ta_id, c.ta_stDt, cp.amount, cp.date, cp.note, cp.p_amount, cp.p_date, cp.p_note FROM cashflow as c, cashflow_payments as cp WHERE c.tbl_id='".$_GET['id']."' AND c.tbl_id=cp.cashflow_id");
														...
														//{
															...
															<div class="form-inline">
																<div class="form-group col-md-5">
                                                                 ...
                                                                 <div class="form-group"> <i class="fa fa-inr"></i>
																		   <input class="form-control" name="fb_received[]" placeholder="Amount" type="text" <?php if(isset($aFB_received[$fb_key])) { ?> value="<?php echo $aFB_received[$fb_key]; ?>" <?php } ?> />
																 </div>     
                                                                 <?php if($f==$f_count) { ?>                                                         
