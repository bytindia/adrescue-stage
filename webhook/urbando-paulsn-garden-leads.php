...
if (count($_POST) > 0 && $_POST['url'] == 'urbando-paulsn-garden') {

    $spreadsheetId = '11LKrAjo4AQvZ6CGz0kQi0Py_AYYty9NhZmQ4V4bgPWE';
    $sheetTab = 'Google';
    ...
    $leadV = [[$name, $email, $ph,$form, $source, $medium, $campaign, $keyword,$term, $url, $formatted_date]];
