...
$mail_from_leads = "noreply@bytindia.com";
$mail_password_leads = "!e@dsANinja";
$mailer_name_leads = "JainHousing Leads";
...
$duration = '';
$subject = 'JainHousing Google Form Leads ('.$_GET['project'].')';
...
try {
	...
	$to_address = "Tamilkani_mktgchn@jainhousing.co.in, bytramesh@gmail.com";
