           ...
           // echo $spreadsheetId = $db->getSheetId($uId,$tbl_id); exit;
            ...
            try {
                ...
                $batchUpdateRequest = new \Google_Service_Sheets_BatchUpdateSpreadsheetRequest(array(
                    ...
                    $batchUpdateRequest2= new \Google_Service_Sheets_BatchUpdateSpreadsheetRequest(array(
                        'requests' => array(
                    ...
                    $result = $service->spreadsheets->batchUpdate($spreadsheetId, $batchUpdateRequest2);
