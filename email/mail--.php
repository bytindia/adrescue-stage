...
$mail_body_1 = "\n
<br/>
Updated on: ".date('d-m-Y, h:i a')."<br/><br/> \n
".$body_text."
...
try {
	...
	$mail->CharSet = 'UTF-8';
    //Recipients
    $mail->setFrom($mail_from_info, 'Alert');
    //$mail->addAddress($receive_email);     // Add a recipient
	$to_address = "prabhu@bytindia.com, ramesh@bytindia.com, charan@bytindia.com, mughil@bytindia.com, faheem@bytindia.com, shaheena@bytindia.com";
