...
/*$html .= '<style>'.file_get_contents('/home/digitalb2k/stage.adrescue.in/assets2/css/bootstrap.css').'</style>';
$html .= '<style>'.file_get_contents('/home/digitalb2k/stage.adrescue.in/vendors/bootstrap/dist/css/bootstrap.min.css').'</style>';
$html .= '<style>'.file_get_contents('/home/digitalb2k/stage.adrescue.in/vendors/font-awesome/css/font-awesome.min.css').'</style>';
$html .= '<style>'.file_get_contents('/home/digitalb2k/stage.adrescue.in/assets2/fonts/icomoon.css').'</style>';
$html .= '<style>'.file_get_contents('/home/digitalb2k/stage.adrescue.in/assets2/css/statistics-card.css').'</style>';
$html .= '<style>'.file_get_contents('/home/digitalb2k/stage.adrescue.in/assets2/css/colors.css').'</style>';
echo $html;*/
         ...
         <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    <h2 style="margin-top:70px;">Here is your Ads audit report <?php echo $rowR['pg_name']; ?></h2>
                  ...
                  <div class="x_content">
                  		<?php
								$fields = array(
									...
									26 => 'Ad Quality Ranking',
									
									27 => 'Objective wise cost per results',
									28 => 'Campaigns - High CPL',
									29 => 'Landing Pages',
									30 => 'Lead Form Questions',
									
									31 => 'Interest-based Targets',
									32 => 'Work Employer Targets',
									33 => 'Work Position Targets',
								...
								$sqlRev = mysqli_query($conn, "SELECT age,active, camp_tot, cbo_camp, pix_act, cust_conv, remarket, top_web_25, top_la_25, rules, cust_aud, la_aud, nar_aud, daily_life, day_part, insta_acc, ig_followers, exp_on, dynamic, img_updated, loc_type, bid_type, placement, age_group, adset_type, ad_type_res,  ad_qty, obj_cost_result, high_cpl, lp_url, lead_qus, interests, work_emp, work_pos FROM audit_data where rep_id='".$_GET['tbl_id']."'");
                                ...
                                <form method="post" action="">
										...
										{ 
										  ...
										  if($rowCount % $numOfCols == 0) { ?> <div class="row"> <?php } 
											...
											?>  
                                                <div class="col-xl-3 col-lg-8 col-xs-12" id="r<?php echo ($k+1); ?>">
                                                    <div class="card">
                                                        <div class="card-body">
                        ...
                        <div class="row">
                          <div class="span9">
							...
							/*if(count($Recom_list)>0) {
								...
								<a href="#" class="list-group-item list-group-item-action active">Recommendations</a>';
								foreach($Recom_list as $k => $v) {
									echo '<a href="#r'.$k.'" class="list-group-item list-group-item-action">'.$k.'. '.$v.'</a>';
								}
								echo '</div>';
							}*/
							?>
                            <div class="list-group">
                                ...
                                <a class="list-group-item list-group-item-action">1. Create Rules to  cost per result</a>
                                <a class="list-group-item list-group-item-action">2. Create Rules to  cost per result</a>
                                <a class="list-group-item list-group-item-action">3. Create Rules to  cost per result</a>
                                <a class="list-group-item list-group-item-action">4. Create Rules to  cost per result</a>
                                <a class="list-group-item list-group-item-action">5. Create Rules to  cost per result</a>
                                <a class="list-group-item list-group-item-action">6. Create Rules to  cost per result</a>
                                <a class="list-group-item list-group-item-action">7. Create Rules to  cost per result</a>
                                <a class="list-group-item list-group-item-action">8. Create Rules to  cost per result</a>
                                <a class="list-group-item list-group-item-action">9. Create Rules to  cost per result</a> 
                          </div>
                          </div>
                        </div>	
